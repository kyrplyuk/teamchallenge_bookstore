...
const Sidebar = () => {
	return (
		<aside className={styles.sideBarBody}>
			<h3 className={styles.sideBarFilters}>Selected filters:</h3>
			...
			<div className={styles.sideBarFilterSecondContainer}>
				<img src='/assets/img/Close%20Icon.svg' alt='close icon' className={styles.sideBarFiltersImg} />
			...
			<div>
				...
				<div className={styles.sideBarFilterAges}>
					<input type='radio' className={styles.sideBarCheckbox} />
